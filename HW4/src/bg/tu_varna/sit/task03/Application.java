 ...
 * така че положителните числа в редицата да се отпечатат, а отрицателните да се
 * съберат със следващото число в редицата.
 * Ако се получи положително число, да се отпечата, ако е < 0, да не се
 * отпечата.
 *
 * За вход 1:
